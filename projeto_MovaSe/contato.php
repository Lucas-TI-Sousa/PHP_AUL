    ...
    <main class="conteudo">
        ...
        if( isset( $_POST['enviar'])){
            ...
            <?php
                ...
                ?>
                <p>Você deve preencher os campos corretamente</p>
                <p><a href= "contato.php">Voltar para o formulário</a></p>
        ...
        ?> 
                    ...
                    <form action="" id="form-contato" method="post">
                        ...
                        <p>
                            ...
                            <textarea tabindex="9" required name="mensagem" id="mensagem" cols="30" rows="6"></textarea>
                        </p>
                        <p>
